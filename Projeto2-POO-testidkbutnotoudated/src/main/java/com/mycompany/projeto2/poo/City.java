...
public class City extends Cell{
    ...
    public double getResource(String type) throws Exception {
        switch(type) {
            case "food":
                return this.foodResources;
            case "industrial":
                return this.industrialResources;
            case "gold":
  ...
  public Civilization getCiv() {return this.civilization;};;
    /**
    ...
    */
    ...
    public void addIndustrialResources(double a){
        industrialResources+=a;
        if(this.industrialResources < 0) {this.industrialResources=0;}
    }
